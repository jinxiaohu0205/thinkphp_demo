...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="/thinkphp/Public/css/webuploader.css" />
...
<input type="submit" value="tijiao" />
	...
	<script type="text/javascript" src="/thinkphp/Public/js/webuploader.min.js"></script>
	<script>
		(function( $ ){
      // 当domReady的时候开始初始化
      $(function() {
         ...
         uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: "<?php echo U('Index/webUpload');?>",  //跳转到服务器地址、 控制器/方法
            // runtimeOrder: 'flash',
